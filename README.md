...
[Read the Blog](https://www.mongodb.com/blog/post/credit-scoring-applications-with-generative-ai){:target="_blank"}
...
The installation is divited into two

[Installation of the backend](./frontend/README.md)

[Installation of the frontend](./src/README.md)
