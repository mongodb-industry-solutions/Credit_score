...
Next, please make sure to add a .env file in the foler <location_of_your_repo>/Credit_score/frontend.
...
> If you want to display a chart here you can do so by following the otional instructions down bellow.
